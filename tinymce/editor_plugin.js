...
(function() {
    tinymce.create('tinymce.plugins.WordCount', {
        ...
        init : function(ed, url) {
            ...
            t.countre = ed.getParam('wordcount_countregex', /[\w\u00C0-\u2013\u2015-\uFFDC]+/g);
            t.cleanre = ed.getParam('wordcount_cleanregex', /[\u2019\'-]*/g);
            t.update_rate = ed.getParam('wordcount_update_rate', 200);
            t.update_on_delete = ed.getParam('wordcount_update_on_delete', true);
        ...
        _getCount : function(ed) {
            ...
            if (tx) {
                ...
                tx = tx.replace(this.cleanre, '');
                // Remove dots and commas from within numbers only.
                tx = tx.replace(/([0-9])[.,]([0-9])/g, '$1$2');
